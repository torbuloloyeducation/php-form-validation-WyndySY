...
// Added error variables for exercises
$phoneErr = $websiteErr = $passwordErr = $confirmPasswordErr = $termsErr = "";

$name = $email = $website = $comment = $gender = "";
// Added data variables for exercises
$phone = $password = $confirmPassword = "";

$submitted = false;
// Exercise 5: Count Validation Attempts
$attempt = isset($_POST['attempt']) ? (int)$_POST['attempt'] : 0;

if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $submitted = true;
    $attempt++; // Increment counter on each POST
    ...
    // Exercise 3 — Password Field with Confirmation
...
// Updated formValid to include all new exercise requirements
$formValid = $submitted && 
             empty($nameErr) && 
             empty($emailErr) && 
             empty($genderErr) && 
    ...
    <form method="post" action="<?= htmlspecialchars($_SERVER["PHP_SELF"]) ?>">
        ...
        <div class="field-row">
            <label class="radio-item">
                ...
                I agree to the terms and conditions <span style="color:var(--error-red)">*</span>
            </label>
